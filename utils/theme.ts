...
export const darkColors: typeof lightColors = {
  ...
  pageBackground: '#111827', // grey[900]
  defaultGrey: '#374151', // grey[700]
  
  text: {
    primary: '#F9FAFB', // grey[50]
    secondary: '#D1D5DB', // grey[300]
    tertiary: '#9CA3AF', // grey[400]
    inverse: '#111827', // grey[900]
    muted: '#9CA3AF', // grey[400]
    placeholder: '#6B7280', // grey[500]
  },

  background: {
    card: '#1F2937', // grey[800]
    page: '#111827', // grey[900]
    input: '#374151', // grey[700]
    pressed: '#374151', // grey[700]
    hover: '#374151', // grey[700]
    imagePlaceholder: '#374151', // grey[700]
  ...
  statusBackground: {
    completed: '#1A3A1F',  // Dark green for dark mode
    overdue: '#3D1F1F',    // Dark red for dark mode
    default: 'transparent',
  },
};
...
const radius = { sm: 8, md: 12, lg: 16, xl: 24, '2xl': 32 };
const spacing = { xs: 4, sm: 8, md: 16, lg: 24, xl: 32, '2xl': 48, '3xl': 64, '4xl': 80 };
const typography = {
  fontFamily: {
